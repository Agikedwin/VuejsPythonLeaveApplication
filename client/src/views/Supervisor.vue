  ...
  <v-card>
    ...
    >
      <template slot="items" slot-scope="props">
        ...
        <td class="text-xs-left"><router-link  class="white--text" :to="{name:addDetails}"><span class="teal--text"> Details</span></router-link></td>
      </template>
...
import api from '../apis/api'
  export default {
    ...
    methods:{
        async fetchEmployee(){
            await api.getEntries('getAllSupervisorsList')
            .then(empList =>{
